...
public class GroupDao {
    ...
    public Boolean addMember(Integer id_member, Integer id_group, Integer id_role, JdbcConnection jdbcConnection) throws IOException, SQLException {
        String SQL = """
    ...
    public Boolean editMember(Integer id_member, Integer id_group, Integer id_role, JdbcConnection jdbcConnection) throws IOException, SQLException {
        String SQL = """
    ...
    public Boolean deleteMember(Integer id_member, Integer id_group, JdbcConnection jdbcConnection) throws IOException, SQLException {
        String SQL = """
    ...
    public Boolean deleteAllMembers(Integer id_group, JdbcConnection jdbcConnection) throws IOException, SQLException {
        String SQL = """
    ...
    public ArrayList<Role> getAllRole(JdbcConnection jdbcConnection) throws IOException, SQLException {
    ...
    public Integer addGroup(String title, JdbcConnection jdbcConnection) throws IOException, SQLException {
        String SQL = """
    ...
    public Boolean editGroup(Integer id_group, String title, JdbcConnection jdbcConnection) throws IOException, SQLException {
        String SQL = """
    ...
    public Boolean deleteGroup(Integer id_group, JdbcConnection jdbcConnection) throws IOException, SQLException {
        String SQL = """
    ...
    public Boolean addWarning(Integer id_member, Integer id_group, Integer id_cautioning, String cause, Integer deadline, JdbcConnection jdbcConnection) throws IOException, SQLException {
        ...
        if (members.stream().anyMatch(a -> Objects.equals(a.getId(), id_member))) {
            ...
            try (Connection connection = jdbcConnection.CreateConnect();
                ...
                try {
                    Integer numbersWarnings = new GroupDao().getCountWarningsFromMemberInGroup(id_member, id_group, jdbcConnection);
                    if (numbersWarnings == 0)
                        return (preparedStatement.executeUpdate() != 0);
                    else if (numbersWarnings > 0)
                        return stopWarning(id_group, id_member, jdbcConnection) && (preparedStatement.executeUpdate() != 0);
                    else return false;
                } catch (SQLException e) {
                    startWarning(id_group, id_member, jdbcConnection);
                    return false;
                }
            }
        }
    ...
    public Boolean deleteWarning(Integer id_group, Integer id_member, JdbcConnection jdbcConnection) throws IOException, SQLException {
        String SQL = """
        ...
        try (Connection connection = jdbcConnection.CreateConnect();
            ...
            preparedStatement.setInt(2, id_member);
            try {
                return preparedStatement.executeUpdate() != 0 && startWarning(id_group, id_member, jdbcConnection);
            } catch (SQLException e) {
                return false;
            }
        }
    ...
    public Boolean deleteAllWarnings(Integer id_group, Integer id_member, JdbcConnection jdbcConnection) throws IOException, SQLException {
        String SQL = """
    ...
    public Boolean deleteAllWarningsInGroup(Integer id_group, JdbcConnection jdbcConnection) throws IOException, SQLException {
        try {
            ArrayList<Warning> result = getAllWarnings(jdbcConnection);
            for (Warning object : result) {
                if (Objects.equals(object.getId_group(), id_group)) {
                    new GroupDao().deleteAllWarnings(id_group, object.getId_member(), jdbcConnection);
                }
            }
            return true;
        }
    ...
    public Boolean startWarning(Integer id_group, Integer id_member, JdbcConnection jdbcConnection) throws IOException, SQLException {
        String SQL = """
    ...
    public Boolean stopWarning(Integer id_group, Integer id_member, JdbcConnection jdbcConnection) throws IOException, SQLException {
        String SQL = """
    ...
    public ArrayList<Warning> getAllWarnings(JdbcConnection jdbcConnection) throws IOException, SQLException {
    ...
    public Integer getCountWarningsFromMemberInGroup(Integer id_member, Integer id_group, JdbcConnection jdbcConnection) throws IOException, SQLException {
        String SQL = """
    ...
    public boolean CheckWarning(JdbcConnection jdbcConnection) {
        try {
            ArrayList<Warning> result = getAllWarnings(jdbcConnection);
            for (Warning object : result) {
                if (object.getDate() != null) {
                    ...
                    if (object.getDate().after(deadline)) {
                        boolean resultDEleted = deleteWarning(object.getId_group(), object.getId_member(), jdbcConnection);
                        if (!resultDEleted)
                            return false;
                    }
                }
    ...
    public ArrayList<Member> getAllMemberInGroup(Integer id_group, JdbcConnection jdbcConnection) throws IOException, SQLException {
    ...
    public ArrayList<Member> getMemberInGroupInChat(Integer id_group, Integer id_chat, JdbcConnection jdbcConnection) throws IOException, SQLException {
        ArrayList<Member> result = new ArrayList<>();
        String SQL = """
                SELECT members.id, first_name, last_name, user_name,
